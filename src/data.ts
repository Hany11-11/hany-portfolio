export const portfolioData = {
  personal: {
    ...
    intro:
      "I'm a software developer passionate about creating efficient and user-friendly web applications with modern technologies.",
    email: "rs11hari@gmail.com",
    phone: "+94 77 133 9016",
    profileImage: "/hany.png",
  },
  experience: [
    {
      ...
      description:
        "Developing a robust Hotel Management System using Spring Boot, focusing on backend modules and RESTful API design.",
    },
  ],
  education: [
    {
  ...
  projects: [
    {
      ...
      description:
        "Comprehensive web application for managing traffic violations with fine calculation and payment processing.",
    ...
    },
    {
      ...
      description:
        "Real-time monitoring of machine status, transaction logs, and cash management.",
    ...
    },
    {
      ...
      description:
        "A React.js-based dashboard editor that lets users edit the header, body, and footer inline. Changes are applied instantly without a page refresh (live preview)",
      tech: ["React.js"],
      link: "#",
      image: "dashboard.png",
    },
    {
      ...
      description:
        "Enterprise-grade solution for bookings, rooms, and guest services.",
      tech: ["React.js", "TypeScript", "Spring Boot", "MySQL"],
      link: "#",
      image: "/hms.jpg",
    },
    {
      title: "UCSC BIT Degree GPA Calculator",
      description:
        "Calculator tool for UCSC BIT students to track semester GPA and overall degree performance.",
  ...
  skills: [
    {
      category: "Frontend",
      items: ["React.js", "TypeScript", "JavaScript", "Tailwind CSS"],
    },
